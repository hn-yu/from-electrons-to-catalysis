...
from catalysis.experiments import microkinetics
...
result=microkinetics(c,args.output)
...
if 'microkinetics'=='rate_control':result['Cantera_degree_of_rate_control']=ct_control(args.input/'mechanism.yaml',t)
if 'sweep' in result:
