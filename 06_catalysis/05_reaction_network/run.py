...
from catalysis.experiments import reaction_network
...
result=reaction_network(c,args.output)
...
if 'reaction_network'=='rate_control':result['Cantera_degree_of_rate_control']=ct_control(args.input/'mechanism.yaml',t)
if 'sweep' in result:
